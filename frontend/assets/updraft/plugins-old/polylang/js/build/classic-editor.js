		...
		tagBox.get = function( id ) {
			...
			$.post(
				...
				function( r, stat ) {
					...
					// @see wp_generate_tag_cloud function which generate the escaped HTML https://github.com/WordPress/WordPress/blob/a02b5cc2a8eecb8e076fbb7cf4de7bd2ec8a8eb1/includes/category-template.php#L966-L975
									...
									function() {
										switch ( this.what ) {
											...
											case 'taxonomy': // categories metabox for posts
												...
												// @see wp_dropdown_categories https://github.com/WordPress/WordPress/blob/5.5.1/includes/category-template.php#L336
											...
											case 'pages': // parent dropdown list for pages
												// @see wp_dropdown_pages https://github.com/WordPress/WordPress/blob/5.2.2/includes/post-template.php#L1186-L1208
												// @see https://github.com/WordPress/WordPress/blob/5.2.2/includes/class-walker-page-dropdown.php#L88
