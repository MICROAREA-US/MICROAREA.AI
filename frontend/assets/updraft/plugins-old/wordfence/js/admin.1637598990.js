				...
				this.ajax('wordfence_updateWAFRules', {}, function(res) {
					...
					if (self.wafData['updated']) {
						...
						if (self.wafData['failure'] == 'ratelimit') {
							...
							self.colorboxModal((self.isSmallScreen ? '300px' : '400px'), __('Rule Update Failed'), __('No rules were updated. Please verify you have permissions to write to the /assets/wflogs directory.'));
						}
					}
